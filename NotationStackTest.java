...
public class NotationStackTest {
  ...
  public double a_= 1.0, b_= 2.0, c_= 3.0, d_= 4.0, e_= 5.0, f_= 6.0;
    ...
    try {
			assertEquals(c_, doubleS.pop(), 0.001);
			assertEquals(b_, doubleS.pop(), 0.001);
			assertEquals(a_, doubleS.pop(), 0.001);
			//Queue is empty, next statement should cause QueueUnderFlowException
			doubleS.pop();
			assertTrue("This should have caused an StackUnderflowException", false);
		}
	...
	public void testPushStudent() {
		...
		//fail("Not yet implemented");
    try {
			assertEquals(3.0, doubleS.size(), 0.001);
			assertEquals(true, doubleS.push(d_));
			assertEquals(4.0, doubleS.size(), 0.001);
			assertEquals(true, doubleS.push(e_));
			assertEquals(5.0, doubleS.size(), 0.001);
			//Queue is full, next statement should cause QueueOverFlowException
			doubleS.push(f_);
			assertTrue("This should have caused an StackOverflowException", false);
		}
